...
/*
если из названия ф-и ясно, что она делает, то комментарий можно не писать ...
show_matrix - понятное название.

в идеале нужно называть переменные и ф-и так, чтобы и без комментария их смысл был ясен.
если при этом название получается слишком длинным, то можно чуть сократить название, но добавить комментарий
*/
